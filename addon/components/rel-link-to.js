...
export default Ember.LinkComponent.extend({
  ...
  */
  qualifiedRouteName: Ember.computed('base', 'targetRouteName', '_routing.currentState', function computeRelLinkToComponentQualifiedRouteName() {
    ...
    return this._process(this.get('base'), this.get('targetRouteName'));
  })
